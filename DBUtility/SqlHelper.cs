...
namespace Fax.DBUtility
{
    public class SqlHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = ConfigurationManager.ConnectionStrings["ytFax"].ConnectionString;
        public static readonly string ConnectionStringytSys = ConfigurationManager.ConnectionStrings["ytSys"].ConnectionString;
        public static readonly string ConnectionStringytFax_DB = ConfigurationManager.ConnectionStrings["ytFax_DB"].ConnectionString;
